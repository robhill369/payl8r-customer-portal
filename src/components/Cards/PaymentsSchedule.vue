<template>
  <div class="flex flex-col lg:flex-row w-full justify-between space-y-7 lg:space-y-0">
    <div
      ...
      :class="previousPaymentDate && isLoanCard ? 'lg:w-64 xl:w-72 3xl:w-[480px]' : 'w-full lg:w-56'"
    >
    ...
    <div
      ...
      class="flex flex-col space-y-4"
      :class="upcomingPaymentDate && isLoanCard || upcomingPaymentDate === null && isLoanCard? 'lg:w-64 xl:w-80 2xl:w-80 3xl:w-[480px]' : 'lg:w-72 xl:w-72 lg:pl-1'"
    >
