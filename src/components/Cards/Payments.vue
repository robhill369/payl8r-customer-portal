<template>
  <div class="flex flex-col lg:flex-row bg-white w-full p-8 pt-6 lg:px-10 lg:pt-6 lg:pb-[34px] rounded-lg justify-between space-y-2 lg:space-y-0">
    <div class="flex flex-col justify-between space-y-2">
      <div class="text-figure">£00.00</div>
