<template>
<!--  <div class="bg-gray-light lg:bg-gray-dark lg:bg-opacity-40 h-screen w-screen fixed top-0 left-0 flex z-40 overflow-auto">-->
<!--    <div class=" lg:w-96 2xl:w-16"/>-->
<!--    <div class="px-5 sm:container py-16 z-50 overflow-auto">-->
<!--      <LoanCard-->
<!--          loan-expanded-->
